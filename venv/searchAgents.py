...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        # added codes:
        # for the error : 'CornersProblem' object has no attribute 'top'
        self.top = top
        self.right = right
    ...
    def isGoalState(self, state):
        ...
        if cornerStates == (True, True, True, True):
            isGoal = True
        else:
            isGoal = False
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                if nextLocation in self.corners:
                    if nextLocation == (self.right, 1):
                        newCornerStates = (True, oldCornerStates[1], oldCornerStates[2], oldCornerStates[3])
                    elif nextLocation == (self.right, self.top):
                        newCornerStates = (oldCornerStates[0], True, oldCornerStates[2], oldCornerStates[3])
                    elif nextLocation == (1, self.top):
                        newCornerStates = (oldCornerStates[0], oldCornerStates[1], True, oldCornerStates[3])
                    elif nextLocation == (1, 1):
                        newCornerStates = (oldCornerStates[0], oldCornerStates[1], oldCornerStates[2], True)
